export type MainView = 'quantum_core' | 'manual_trading' | 'desk' | 'simulator' | 'portfolio' | 'settings' | 'news' | 'support' | 'notifications' | 'history' | 'legal' | 'document' | 'business-plan' | 'marketing-strategy' | 'technical-spec' | 'ui-guide' | 'security-compliance' | 'legal-privacy';
